...
def get_joypixels():
    ...
    data = json.load(urlopen(remote + '/codes.json'))
    codes = {}
...
def update_codes():
    with open('sphinx_syft_theme/symoji.json', encoding='utf-8') as current:
    ...
    for getter in [
        ...
        codes.update(getter())
    with open('sphinx_syft_theme/symoji.json', 'w', encoding='utf-8') as output:
